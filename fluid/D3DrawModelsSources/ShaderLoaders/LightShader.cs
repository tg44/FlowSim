...
namespace fluid.D3DrawModelsSources.ShaderLoaders
{
    class LightShader
    {
        ...
        internal struct LightBuffer
        {
            ...
            public float padding; // Added extra padding so structure is a multiple of 16 for CreateBuffer function requirements.
        }
        ...
        private bool InitializeShader(Device device, IntPtr windowHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                psFileName = ShadersFilePath + psFileName;

                // Compile the vertex shader code.
                var vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileName, "LightVertexShader", "vs_4_0", ShaderFlags.Debug, EffectFlags.None);
                // Compile the pixel shader code.
                var pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileName, "LightPixelShader", "ps_4_0", ShaderFlags.Debug, EffectFlags.None);
