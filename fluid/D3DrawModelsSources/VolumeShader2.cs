...
namespace fluid.D3DrawModelsSources
{
    class VolumeShader2
    {
        ...
        public bool Initialize(SharpDX.Direct3D11.Device device, IntPtr windowHandler)
        {
            ...
            return InitializeShader(device, windowHandler, @"..\..\Shaders\test.vs", @"..\..\Shaders\test.ps");
        }
        ...
        private bool InitializeShader(SharpDX.Direct3D11.Device device, IntPtr windowHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                var vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileName, "VolumeVertexShader", "vs_4_0", ShaderFlags.None, EffectFlags.None);
                // Compile the pixel shader code.
                var pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileName, "VolumePixelShader", "ps_4_0", ShaderFlags.None, EffectFlags.None);
